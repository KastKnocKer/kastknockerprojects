...
public class PanelInserimentoOrdine extends VLayout{
	...
	private void addForm(){
		...
		confermaButton.setTitle("Inserisci");
		
		form.setFields( new FormItem[] {dataCreazioneOrdine, dataPartenzaMerce, TipoOrdine, Trasportatore, Fornitore, note, confermaButton} );
		this.addMember(form);
		
		
		confermaButton.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
