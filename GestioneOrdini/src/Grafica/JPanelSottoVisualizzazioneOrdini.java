...
public class JPanelSottoVisualizzazioneOrdini extends JPanel implements ActionListener{
	...
	public JPanelSottoVisualizzazioneOrdini(){
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(162, 162, 162))
            .addComponent(Separatore, javax.swing.GroupLayout.DEFAULT_SIZE, 664, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(JT_Note, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
	...
	public void actionPerformed(ActionEvent AE) {
		...
		if( action.equals("Aggiungi Ordinazione")){
			...
			String cognome=(String) JCB_Cognome.getSelectedItem();
			String Campi = "IDOrdine, Quantita, CodiceProdotto, IDCliente, Annotazioni";
			String Valori = "'"+ ListaOrdini.IDUltimoOrdine+"', '"+ JT_Quantita.getText() +"', '"+ codiceprodotto +"', '"+ ListaClienti.getIDClientedaNomeCognome(cognome, nome) +"', '"+ JT_Note.getText() +"'";
